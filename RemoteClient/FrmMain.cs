...
{//Dr Gadgit RNCDesktop@Safe-mail.net http://www.codeproject.com/Articles/897746/Windows-remote-desktop-application
    public partial class FrmMain : Form
    {
        ...
        public static FrmHelp FrmHelping = null;
            ...
            try
            {
                ...
                while (true)
                {
                    ...
                    try
                    {
                        ...
                        {
                            Color C1 = inImage.GetPixel(0, 0);
                            Color C2 = inImage.GetPixel(0, 1);
        ...
        private void Form2_Load(object sender, EventArgs e)
        {
            ...
            this.ChkDebug.Checked = Settings.Debug;
            this.ChkScale.Checked = Settings.Scale;
            this.ChkBlackWallpaper.Checked = Settings.BlackWallpaper;
            this.ChkEncrypted.Checked = Settings.Encrypted;
            this.ChkResoloution.Checked = Settings.Resoloution;
            this.ChkSendKeyboardAndMouse.Checked = Settings.SendKeysAndMouse;
            this.TxtIPAddress.Text  = Settings.IP;
            this.txtPassword.Text = Settings.PassWord;
            this.ChkLeftMenu.Checked = Settings.LeftMenu;
            this.ChkLeftMenuConnect.Checked = Settings.LeftMenu;
        ...
        {
            SendCommand("ENCRYPTED " + ChkEncrypted.Checked.ToString()); Thread.Sleep(20);
            SendKeySync(); Thread.Sleep(20);
            SendCommand("WALLPAPER " + ChkBlackWallpaper.Checked.ToString()); Thread.Sleep(20);
            SendCommand("DEBUG " + ChkDebug.Checked.ToString()); Thread.Sleep(20);
            SendCommand("SCALE " + ChkScale.Checked.ToString()); Thread.Sleep(20);
            SendCommand("RESOLUTION " + ChkResoloution.Checked.ToString()); Thread.Sleep(20);
        }
        ...
        private void Form2_Resize(object sender, EventArgs e)
        {
            ...
            else
            {
                if (Settings.Connected)
                {
                    ...
                    CmdMenuSmall.Top = 0;
                    if (Settings.LeftMenu)
                        CmdMenuSmall.Left = 25;
                    else
                        CmdMenuSmall.Left = this.Width / 2;
                    CmdMenuSmall.Visible = true;
                    GroupConnect.Visible = false;
                    GroupConnect.Enabled = false;
        ...
        {
            Settings.Debug = ChkDebug.Checked;
            SendCommand("DEBUG " + ChkDebug.Checked.ToString());
        }

        private void ChkScale_CheckedChanged(object sender, EventArgs e)
        {
            Settings.Scale = ChkScale.Checked;
            SendCommand("SCALE " + ChkScale.Checked.ToString());
        }

        private void ChkResoloution_CheckedChanged(object sender, EventArgs e)
        {
            Settings.Resoloution = ChkResoloution.Checked;
            SendCommand("RESOLUTION " + ChkResoloution.Checked.ToString());
        }

        private void ChkEncrypted_CheckedChanged(object sender, EventArgs e)
        {
            Settings.Encrypted = ChkEncrypted.Checked;
            SafeSendValue("LOCK");
            SendCommand("ENCRYPTED " + ChkEncrypted.Checked.ToString());
        ...
        {
            Settings.SendKeysAndMouse = ChkSendKeyboardAndMouse.Checked;
        }
        ...
        {
            Settings.LeftMenu = ChkLeftMenu.Checked;
        ...
        private void ChkLeftMenuConnect_CheckedChanged(object sender, EventArgs e)
        {
            ...
            ChkLeftMenu.Checked = Settings.LeftMenu;
        }

        private void CmdHelp_MouseClick(object sender, MouseEventArgs e)
        {
            if (FrmHelping == null) FrmHelping = new FrmHelp();
            FrmHelping.Show();
        }

        private void CloseHelp()
        {
            if (FrmHelping == null) return;
            FrmHelping.Close();
            FrmHelping = null;
        }
        ...
        {
            Closing = true;
            if (FrmHelping != null) FrmHelping.Close();
            if (Settings.Connected) CmdDisconect_MouseClick(null, null);
        }

        private void theImage_Click(object sender, EventArgs e)
        {
